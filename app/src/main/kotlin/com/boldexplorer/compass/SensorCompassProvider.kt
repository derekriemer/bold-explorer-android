 ...
 */
@Singleton
class SensorCompassProvider @Inject constructor(
    ...
    val headingFlow: SharedFlow<HeadingReading> = callbackFlow {
        ...
        val listener = object : SensorEventListener {
            override fun onSensorChanged(event: SensorEvent) {
                ...
                val trueDeg: Double? = if (loc != null) {
                    val (lat, lon, alt) = loc
     ...
     */
    fun setLocation(lat: Double, lon: Double, altM: Double = 0.0) {
